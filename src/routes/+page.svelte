...
<svelte:head>
  <title>SDrive video HLS upload microservice</title>
  <meta name="title" content="SDrive video HLS upload microservice" />
...
<div class="main">
  ...
  <p>
    Click on <a href="/upload">Upload</a> to upload a video file or <a href="/videos">Videos</a> to view
    uploaded videos.
  </p>
  <p>
    Videos will be converted to HLS format and uploaded via SDrive to Shadow Drive for streaming.
  </p>
  <p>
